...
class Reservation(models.Model):
    ...
    def priceTotal(self):
        diarias = (self.checkout - self.checkin).days
        return (self.price or 0) * diarias + (self.rate or 0)

    def __str__(self):
        return f'Nome: {self.user.username}; id Usuário: {self.id_user}; Nome do Imóvel: {self.nameProperty}; id Reserva: {self.id_reservation}'
